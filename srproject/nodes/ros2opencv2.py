...
class ROS2OpenCV2(object):
    def __init__(self, node_name):        
        ...
        self.topicname1 = rospy.get_param("~topicname1", "/roi")
        # Initialize the Region of Interest and its publisher
        self.ROI = RegionOfInterest()
        self.roi_pub = rospy.Publisher(self.topicname1, RegionOfInterest)
        ...
        self.cv_window_name = self.node_name+self.topicname1
