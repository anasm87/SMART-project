...
""" Object Match Detect Track ...........inspired from ROS by examples scripts 
"""
...
class ObjectMatchDetectTrack(ROS2OpenCV2):
...
if __name__ == '__main__':
    try:
        node_name = "ObjectMatchDetectTrack"
        ObjectMatchDetectTrack(node_name)
        try:
